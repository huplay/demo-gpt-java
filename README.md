...
| Name             | Hidden size | Decoder no. | Head no. | Context size | Size of params | Notes            | Download                                                                                             |
|------------------|------------:|------------:|---------:|-------------:|---------------:|------------------|------------------------------------------------------------------------------------------------------|
...
| GPT-2 XL         |        1600 |          48 |       25 |         1024 |        1,558 M | GPT-2            | [Link 1](https://github.com/huplay/GPT2-XL) <br /> [Link 2](https://github.com/huplay/GPT2-XL-part2) |

### OpenAI GPT-3 ###

(Parameters are not published)

| Name             | Hidden size | Decoder no. | Head no. | Context size | Size of params | Notes            | 
|------------------|------------:|-------------:|---------:|-------------:|---------------:|------------------|
